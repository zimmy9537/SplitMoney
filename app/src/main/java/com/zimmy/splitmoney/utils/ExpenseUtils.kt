...
class ExpenseUtils {
    companion object {
        ...
        fun getMinAdvanced(transactionList: ArrayList<Transaction>): Int {
            var minIndex = 0
        ...
        fun getMaxAdvanced(transactionList: ArrayList<Transaction>): Int {
            var maxIndex = 0
            for (i in transactionList.indices) {
        ...
        fun minOf2Advanced(x: Double, y: Double): Double {
